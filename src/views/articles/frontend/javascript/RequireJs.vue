<template lang="pug">
    BoWen
        ...
        .px-1
            ...
            p 原始写法一个很明显的缺陷，加载多个文件的时候，浏览器会停止网页渲染，加载文件越多，网页失去响应的时间就会越长；其次，由于 js 文件之间存在依赖关系，因此必须严格保证加载顺序，依赖性最大的模块一定要放到最后加载，当依赖关系很复杂的时候，代码的编写和维护都会变得困难。
            ...
            p.text-right 还没有看够？点击 
                a(href="/#/articles/frontend/javascript/RequireJS-1") RequireJS (二) 
                | 查看更多内容。
            p.text-right 参考资料：
