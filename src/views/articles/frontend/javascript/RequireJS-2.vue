<template lang="pug">
    BoWen
        ...
        .px-1
            ...
            img.d-block.ml-2.mb-1(src="../../../../static/images/articles/frontend/javascript/require-shim.png", alt="模块的定义", style="height: 200px")
            ...
            p.text-right 还没有看够？点击 
                a(href="/#/articles/frontend/javascript/RequireJS-3") RequireJS (四) 
                | 查看更多内容。
            p.text-right 参考资料：
